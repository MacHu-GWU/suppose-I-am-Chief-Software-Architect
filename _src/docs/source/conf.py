# -*- coding: utf-8 -*-
#
# iamcsa documentation build configuration file, created by
...
version = iamcsa.__version__
# The full version, including alpha/beta/rc tags.
release = iamcsa.__version__
...
html_logo = "./_static/iamcsa-logo.png"
html_favicon = "./_static/iamcsa-favicon.ico"
...
latex_documents = [
    (master_doc, 'iamcsa.tex', 'iamcsa Documentation',
     u'Sanhe Hu', 'manual'),
]
...
man_pages = [
    (master_doc, 'iamcsa', 'iamcsa Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'iamcsa', 'iamcsa Documentation',
     author, 'iamcsa', 'One line description of project.',
     'Miscellaneous'),
]
...
# Add data for Jinja2
try:
    from iamcsa.docs import doc_data
except:
    doc_data = dict()
